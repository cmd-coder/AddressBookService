...
--Use Case 10
select count(type), type from address_book group by type;

--Use Case 11
insert into address_book values('First2', 'Last2', 'Address2', 'City2', 'State2', 455678, '54564654656','eesvgrgvw', 'home', 'Family');
